...
class SlidingTabStrip extends LinearLayoutCompat {
...
//    }
    ...
    SlidingTabStrip(Context context, AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mDefaultTabColorizer.setIndicatorColors(DisplayUtils.getColor(context, R.attr.colorSecondary));
    ...
    /**
     * Set the alpha value of the {@code colors} to be the given {@code alpha} value.
     */
