 ...
 * which colors is used for any individual position.
 * <p>
...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     * circular array. Providing one colors will mean that all tabs are indicated with the same colors.
     */
     ...
     * Providing one colors will mean that all tabs are indicated with the same colors.
     */
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setTextColor(DisplayUtils.getColor(context, R.attr.colorPrimary));
    ...
    public interface TabColorizer {
        ...
        /**
         * @return return the colors of the indicator used when {@code position} is selected.
         */
        int getIndicatorColor(int position);

        /**
         * @return return the colors of the divider drawn to the right of {@code position}.
         */
