...
class SimpleMultipartEntity implements HttpEntity {
    ...
    private byte[] createContentType(String type) {
        String result = CachingAsyncHttpClient.HEADER_CONTENT_TYPE + ": " + normalizeContentType(type) + STR_CR_LF;
        return result.getBytes();
    }

    private byte[] createContentDisposition(String key) {
        return (
                CachingAsyncHttpClient.HEADER_CONTENT_DISPOSITION +
    ...
    public Header getContentType() {
        return new BasicHeader(
                CachingAsyncHttpClient.HEADER_CONTENT_TYPE,
    ...
    private class FilePart {
        ...
        public void writeTo(OutputStream out) throws IOException {
            ...
            out.flush();
            CachingAsyncHttpClient.silentCloseInputStream(inputStream);
        }
    }
}