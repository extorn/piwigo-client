...
public class TagsGetAdminListResponseHandler extends AbstractPiwigoWsResponseHandler {
    ...
    protected void onPiwigoSuccess(JsonElement rsp) throws JSONException {
        ...
        PiwigoGetTagsAdminListRetrievedResponse r = new PiwigoGetTagsAdminListRetrievedResponse(getMessageId(), getPiwigoMethod(), page, pageSize, tags.size(), tags);
        storeResponse(r);
    }
    ...
    public static class PiwigoGetTagsAdminListRetrievedResponse extends TagsGetListResponseHandler.PiwigoGetTagsListRetrievedResponse {
        ...
        public PiwigoGetTagsAdminListRetrievedResponse(long messageId, String piwigoMethod, int page, int pageSize, int itemsOnPage, HashSet<Tag> tags) {
