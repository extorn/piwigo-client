...
public class CustomSlidingLayer extends FrameLayout {
     ...
     */
    @RequiresApi(21)
    public CustomSlidingLayer(Context context, AttributeSet attrs, int defStyle, int defTheme) {
        super(context, attrs, defStyle, defTheme);

        init(context, attrs, defStyle, defTheme);
    ...
    /**
     * Sets the default location where the CustomSlidingLayer will appear
     *
    ...
    /**
     * Handler interface for obtaining updates on the <code>CustomSlidingLayer</code>'s state.
     * <code>OnInteractListener</code> allows for external classes to be notified when the <code>CustomSlidingLayer</code>
     * receives input to be opened or closed.
     */
    public interface OnInteractListener {

        /**
         * This method is called when an attempt is made to open the current <code>CustomSlidingLayer</code>. Note
         * that because of animation, the <code>CustomSlidingLayer</code> may not be visible yet.
         */
        void onOpen();

        /**
         * This method is called when an attempt is made to show the preview mode in the current
         * <code>CustomSlidingLayer</code>. Note that because of animation, the <code>CustomSlidingLayer</code> may not be
         * visible yet.
         */
        void onShowPreview();

        /**
         * This method is called when an attempt is made to close the current <code>CustomSlidingLayer</code>. Note
         * that because of animation, the <code>CustomSlidingLayer</code> may still be visible.
         */
        void onClose();
         ...
         * <code>CustomSlidingLayer</code> is
