...
public class LruExifCache implements Cache {
    ...
    public LruExifCache(int maxSize) {
        ...
        metadataMap = new LinkedHashMap<String, Metadata>(0, 0.75f, true);
    }
    ...
    public Metadata getMetadata(Bitmap bitmap) {
        if (bitmap == null) {
    ...
    public void setMetadata(String uri, Metadata metadata) {
