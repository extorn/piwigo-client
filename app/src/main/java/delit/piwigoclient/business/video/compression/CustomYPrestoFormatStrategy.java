...
public class CustomYPrestoFormatStrategy implements MediaFormatStrategy {
    ...
    public CustomYPrestoFormatStrategy() {
        this(DEFAULT_VIDEO_BITRATE);
    }

    public CustomYPrestoFormatStrategy(int videoBitrate) {
        this(videoBitrate, AUDIO_BITRATE_AS_IS, AUDIO_CHANNELS_AS_IS);
    }

    public CustomYPrestoFormatStrategy(int videoBitrate, int audioBitrate, int audioChannels) {
