...
public class SharedFilesClonedIntentProcessingTask<F extends RecyclerViewDocumentFileFolderItemSelectFragment<F,FUIH,P>, FUIH extends FragmentUIHelper<FUIH,F>,P extends FolderItemViewAdapterPreferences<P>> extends OwnedSafeAsyncTask<F, List<FolderItem>, Integer, List<FolderItem>> {
    ...
    protected List<FolderItem> doInBackgroundSafely(List<FolderItem> ... params) {
        ...
        DividableProgressTracker progressTracker = new DividableProgressTracker("files cloning",  100,new SafeAsyncTask.AsyncTaskProgressLink(this::onProgressUpdate));
        ...
        DividableProgressTracker cacheProgressTracker = progressTracker.addChildTask("caching files information", 100, 20);
        itemsShared.clear();
