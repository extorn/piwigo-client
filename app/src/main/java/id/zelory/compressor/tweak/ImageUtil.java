...
class ImageUtil {
    ...
    static File compressImage(FileDescriptor imageFd, int reqWidth, int reqHeight, Bitmap.CompressFormat compressFormat, int quality, String destinationPath) throws IOException {
        ...
        try {
            ...
            try(FileInputStream is = new FileInputStream(file)){
                decodeSampledBitmapFromFile(is, reqWidth, reqHeight, getExif(imageFd)).compress(compressFormat, quality, fileOutputStream);
            }
        } finally {
